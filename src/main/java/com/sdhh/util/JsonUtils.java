...
public class JsonUtils {
    ...
    public static void main(String []args){
        List<YearProjectTree> list = new ArrayList<>();
        YearProjectTree y1 = new YearProjectTree();
        y1.setId("1");
        y1.setText("text1");
        y1.setState("open");
        YearProjectTree y2 = new YearProjectTree();
        y2.setId("2");
        y2.setText("text2");
        y2.setState("closed");
        list.add(y1);
        list.add(y2);
        System.out.println(JsonUtils.encodeObject(list));
    }
}
